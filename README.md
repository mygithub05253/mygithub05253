...
- **[신용 위험 예측 시스템](https://gitlab.com/dev-dongwon05253/credit-risk-project)** &nbsp;`Python`
  금융 데이터의 통계적 엄밀성을 확보하고, 설명 가능한 AI(XAI)로 실무적 부실 방지 정책을 제안하는 End-to-End 시스템.
  <!-- 상세 서술 추가 위치: 아래 주석을 풀고 내용을 채우면 접기 블록이 생깁니다
  <details><summary>🧠 기술적으로 고민한 부분</summary>

  (문제 / 해결 / 결과 / 회고)
  </details>
  -->

- **[ESG DART 비정형 데이터 분석](https://github.com/dev-dongwon05253/unstructured-data-processing-final-project)** &nbsp;`Python` `팀 프로젝트`
